...
LIBRARY_CSV="/gpfs/commons/home/jameslee/Cas13/liver_atlas/metadata/mouse_library_v3.csv"

# Create logs directory if it doesn't exist
# mkdir -p ${OUTPUT_BASE_DIR}/logs

# Get the sample list for Mus musculus
SAMPLE_CSV="/gpfs/commons/home/jameslee/Cas13/liver_atlas/metadata/mouse_SRR_list_v3.txt"
